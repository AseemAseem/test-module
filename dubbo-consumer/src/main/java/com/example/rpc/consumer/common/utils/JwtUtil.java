...
public class JwtUtil {
     ...
     * @return jwt String
     */
    public static String createJWT(String subject, int userVersion, long ttlMillis) {
        ...
        claims.put("userVersion", userVersion);
    ...
    public static void main(String[] a) {
        String jwt = JwtUtil.createJWT(PropertiesUtil.getProperty("TEMP_UUID"), 0, Long.valueOf(PropertiesUtil.getProperty("LIMIT_SECOND")));
